  ...
  return <div className="gutter space-y-7 py-8">
    ...
    <div className="grid items-start gap-7 lg:grid-cols-[260px_1fr]">
      ...
      <section className="min-w-0 border border-card-border bg-card" aria-label="Educational simulation transcript">
        <div className="flex items-center justify-between gap-3 border-b border-card-border bg-surface-dark px-5 py-4 text-on-ink"><span className="micro">{t("Scam sandbox")}</span><span className="border border-accent/50 px-2 py-1 font-mono text-[10px] uppercase tracking-wider text-on-ink/80">{t("Simulation only")}</span></div>
